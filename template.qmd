...
NPV is very dependent on storm surge mean, espevially for lower elevation values.
...
For the elevation values tested, we see the best results around 8 feet of elevation.  We seem to start having deminishing returns once we elevate higher than this.  
